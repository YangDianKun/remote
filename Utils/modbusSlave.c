...
static volatile uint8_t g_mods_timeout = 0;
static void MODS_ReciveNew(uint8_t _byte);
...
void MODS_Init (void)
{
	 //bsp_InitHardUsart1witchRs485 (SBAUD485, MODS_ReciveNew);
}
...
static void MODS_ReciveNew(uint8_t _byte)
{
	...
	*/
	...
	/* 硬件定时中断，定时精度us ，定时器2用于Modbus */
	//bsp_StartHardTimer5(TIMER5_CC_1_MODS, timeout, (void *)MODS_RxTimeOut);
